...
@Entity
@Table(name = "customer")
public class Doner extends AbstractModel {
    ...
    @OneToMany(
            ...
            // make sure to remove ipsses if unlinked from customer
            orphanRemoval = true,
    ...
    private List<Ipss> ipsses = new ArrayList<>();
    ...
    /**
     * Gets the customer ipsses
     *
     * @return the ipsses
     */
    public List<Ipss> getIpsses() {
        return ipsses;
    }
    ...
    /**
     * Adds a new ipss to the customer
     *
     * @param ipss the ipss to add
     */
    public void addRecipient(Ipss ipss) {
        ipsses.add(ipss);
        ipss.setCustomer(this);
    }

    /**
     * Removes a ipss from the customer
     *
     * @param ipss the ipss to remove
     */
    public void removeRecipient(Ipss ipss) {
        ipsses.remove(ipss);
        ipss.setCustomer(null);
    }
